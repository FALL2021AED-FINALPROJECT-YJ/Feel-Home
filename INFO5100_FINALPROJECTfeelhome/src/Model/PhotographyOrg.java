...
public class PhotographyOrg extends Organization {
    ...
    public static enum PhotographyType {
        ...
        PLATINUM(200, "Premiume", "Includes 2 candid photograhers and 2 videographers");
    ...
    public PhotographyOrg(String name, String contact, String city) {
