...
public class Main1JFrame extends javax.swing.JFrame {
    ...
    private void loginBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginBtnActionPerformed
        ...
        if (username.equals("") && password.equals("")) {
            SystemAdministrationJPanel systemAdministration = new SystemAdministrationJPanel(systemAdmin, this::renderNetworkPanel, this::renderEnterprisePanel, this::renderCustomerPanel);
            jSplitPane.setRightComponent(systemAdministration);
        }

        if (username.matches("customer")) {
    ...
    private void renderSystemAdminPanel() {
        jSplitPane.setRightComponent(new SystemAdministrationJPanel(systemAdmin, this::renderNetworkPanel, this::renderEnterprisePanel, this::renderCustomerPanel));
    }
